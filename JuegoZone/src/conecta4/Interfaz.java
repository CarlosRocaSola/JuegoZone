...
public class Interfaz extends javax.swing.JFrame {
    ...
    */
    ...
    //Calcula el tama�o que tendr� el tablero. Le resta los m�rgenes izquierdo y superior respectivamente.
    anchuraTablero = jPanel1.getSize().width-40;
    alturaTablero = jPanel1.getSize().height-70;

    //Como estamos sobreescribiendo la funci�n llamamos a la funci�n padre.
    super.paint(g);
    g = jPanel1.getGraphics();

    //Dibuja el tablero como un rect�ngulo azul.
    ...
    //Calcula el tama�o que ocupar� cada casilla a partir del tama�o del tablero.
    ...
    //S1 la casilla pertenece al jugador 1, la dibuja de color rojo
    			...
    			if(m_nuevoJuego.m_tablero.obtenerCasilla(j, i) == 2)
    				g.setColor(Color.YELLOW);
    			else //Si la casilla est� vac�a, la dibuja de co1or negro
    				g.setColor(Color.darkGray);

    			//Calcula la posici�n en la que debe dibujar la casilla
