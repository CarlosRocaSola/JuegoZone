...
public class Brick extends WorldObject {
	...
	/*
	 * Permite que todos los objetos de esta misma clase puedan pasar de una
	 * imagen a otra todos sincronizados.
	 */
	...
	/*
	 * Permite actualizar las imágenes para todos los objetos de esa clase.
	 */
	...
	public Brick(Stage s) {
		...
		if (first) {
			...
			for (int i = 0; i < audio.length; i++) {
				audio[i] = stage.getSoundsLoader().getAudio("coin.wav", true,
						true); // TODO nombre de los sonidos
			}
		}
	}
